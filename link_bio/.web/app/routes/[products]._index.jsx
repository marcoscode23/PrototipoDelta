...
function Flex_04071c3e40ddae540882662df39806c1 () {
  const reflex___state____state__link_bio___views___products___products____cart_state = useContext(StateContexts.reflex___state____state__link_bio___views___products___products____cart_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);
  ...
  return (
    jsx(RadixThemesFlex,{align:"start",className:"rx-Stack",css:({ ["width"] : "100%" }),direction:"column",gap:"7"},Array.prototype.map.call(reflex___state____state__link_bio___views___products___products____cart_state.cart_items_rx_state_ ?? [],((item_rx_state_,i_rx_state_)=>(jsx(RadixThemesFlex,{align:"start",className:"rx-Stack",css:({ ["paddingTop"] : "10px", ["paddingBottom"] : "10px", ["borderBottom"] : "1px solid #eee", ["width"] : "100%" }),direction:"row",justify:"between",key:i_rx_state_,gap:"4"},jsx(RadixThemesFlex,{align:"start",className:"rx-Stack",direction:"row",gap:"3"},jsx("img",{css:({ ["width"] : "70px", ["height"] : "70px", ["borderRadius"] : "10px", ["marginLeft"] : "10px" }),src:item_rx_state_["imagen"]},),jsx(RadixThemesFlex,{align:"start",className:"rx-Stack",css:({ ["alignItems"] : "start" }),direction:"column",gap:"1"},jsx(RadixThemesText,{as:"p",css:({ ["fontWeight"] : "bold", ["color"] : "black" })},item_rx_state_["nombre"]),jsx(RadixThemesText,{as:"p",css:({ ["fontSize"] : "13px", ["color"] : "#555" })},("Talle: "+(isTrue(item_rx_state_["talle"]) ? item_rx_state_["talle"] : "\u2014"))),jsx(RadixThemesText,{as:"p",css:({ ["fontSize"] : "13px", ["color"] : "#555" })},("Cantidad: "+item_rx_state_["cantidad"])))),jsx(RadixThemesFlex,{css:({ ["flex"] : 1, ["justifySelf"] : "stretch", ["alignSelf"] : "stretch" })},),jsx(RadixThemesFlex,{align:"start",className:"rx-Stack",css:({ ["marginTop"] : "0px", ["alignItems"] : "end", ["paddingRight"] : "15px" }),direction:"column",gap:"3"},jsx(RadixThemesFlex,{align:"center",className:"rx-Stack",direction:"row",gap:"3"},jsx(RadixThemesText,{as:"p",css:({ ["color"] : "#DAA520", ["fontWeight"] : "bold", ["fontSize"] : "15px", ["marginRight"] : "8px" })},("$"+item_rx_state_["precio"])),jsx(RadixThemesIconButton,{color:"red",css:({ ["padding"] : "6px" }),onClick:((_e) => (addEvents([(ReflexEvent("reflex___state____state.link_bio___views___products___products____cart_state.remove_from_cart", ({ ["index"] : i_rx_state_ }), ({  })))], [_e], ({  })))),size:"2"},jsx(LucideTrash,{size:24},)))))))))
  )
}
