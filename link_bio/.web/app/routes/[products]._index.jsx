...
function Link_40ac57b73fe0e34f10e23bdd8286a735 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);



  return (
    jsx(RadixThemesLink,{asChild:true,css:({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })},jsx(ReactRouterLink,{to:"/detalle/NEW_BALANCE_9060"},jsx("img",{css:({ ["width"] : "200px", ["height"] : "250px", ["borderRadius"] : "8px", ["&:hover"] : ({ ["transform"] : "scale(1.05)", ["cursor"] : "pointer" }) }),onClick:((_e) => (addEvents([(ReflexEvent("reflex___state____state.link_bio___views___products___products____cart_state.select_image", ({ ["img"] : "NEWBALANCE906060.png" }), ({  })))], [_e], ({  })))),src:"NEWBALANCE906060.png"},)))
  )
}


function Button_68646f582d9a6627c0fb0b3d4b1cd5aa () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_click_609ad991277e60f0260b8ec823d9f993 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.link_bio___views___products___products____cart_state.toggle_cart_modal", ({ ["nombre"] : "NEW BALANCE 9060", ["imagen"] : "NEWBALANCE906060.png", ["precio"] : "$90.000" }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx(RadixThemesButton,{css:({ ["color"] : "white", ["background"] : "#DAA520", ["&:hover"] : ({ ["transform"] : "scale(1.05)" }) }),onClick:on_click_609ad991277e60f0260b8ec823d9f993},"A\u00f1adir al carrito")
  )
}
...
function Fragment_37e4b80052f15a42b3ba91c9701f512c () {
  const reflex___state____state__link_bio___views___products___products____cart_state = useContext(StateContexts.reflex___state____state__link_bio___views___products___products____cart_state)
