...
def login() -> rx.Component:
    return rx.box(
        ...
        rx.center(
            rx.vstack(
                rx.text("Inicio / Mi Cuenta / ", font_weight="bold", color="black"),
                rx.text("Login", as_="span", font_weight="bold", color="black"),
                rx.box(
                    rx.text("EMAIL", font_weight="bold", color="black"),
                    rx.input(placeholder="ej.: tunombre@email.com", width="100%", color="black"),
                    rx.text("CONTRASEÑA", font_weight="bold", margin_top="10px", color="black"),
                    rx.hstack(
                        rx.input(type_="password", placeholder="********", width="100%", color="black"),
                        rx.icon(tag="eye-off", color="black"),
                    ),
                    rx.link(
                ...
                rx.text("¿No tenés cuenta?", color="black"),
                rx.link("Crear cuenta", href="/register", color="black", font_weight="bold"),
                spacing="3",
                justify="center",
                padding_bottom="40px",
                align="center",
